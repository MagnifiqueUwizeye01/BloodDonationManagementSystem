 ...
 * @author Magnifique
 */
public class BloodRequestForm extends javax.swing.JFrame {
    private User currentUser;
    private BloodRequestDao requestDao;
    
    
    // Constructor modification
    public BloodRequestForm(User currentUser) {
    ...
    private void initComponents() {
        ...
        backBtn.setForeground(new java.awt.Color(150, 0, 0));
        backBtn.setText("Back");
        backBtn.setBorder(javax.swing.BorderFactory.createEmptyBorder(10, 15, 10, 15));
        ...
        tablePanelLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, tablePanelLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(requestsScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 868, Short.MAX_VALUE)
                .addContainerGap())
        );
        tablePanelLayout.setVerticalGroup(
            tablePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(tablePanelLayout.createSequentialGroup()
                .addComponent(requestsScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 189, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    try {
        ...
        if (requestDao.saveRequest(request) > 0) {
