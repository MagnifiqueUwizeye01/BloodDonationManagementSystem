# Blood Donation Management System — Phase 1 (DAO / Model / View)
...
Open the project folder as an existing project

Add your JDBC driver JAR to the project libraries (manual step)
